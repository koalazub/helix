...
fn configure_engine_impl(mut engine: Engine) -> Engine {
    ...
    // (Kernel management lives in the nothelix Steel plugin's
    // libnothelix dylib — Helix should not know about Julia/Python
    // kernels or any specific notebook runtime.)
