...
(define (jump-label-alphabet arg)
    (helix.jump-label-alphabet *helix.config* arg))
...
(define (rainbow-brackets arg)
    (helix.rainbow-brackets *helix.config* arg))
...
(define (set-keybindings! arg)
    (helix.set-keybindings! *helix.config* arg))
...
(define (inline-diagnostics-other-lines-enable arg)
    (helix.inline-diagnostics-other-lines-enable *helix.config* arg))
...
(define (inline-diagnostics-min-diagnostics-width arg)
    (helix.inline-diagnostics-min-diagnostics-width *helix.config* arg))

(provide inline-diagnostics-prefix-len)
;;@doc
;;;;Inline diagnostics prefix length
(define (inline-diagnostics-prefix-len arg)
    (helix.inline-diagnostics-prefix-len *helix.config* arg))

(provide inline-diagnostics-max-wrap)
;;@doc
;;;;Inline diagnostics maximum wrap
(define (inline-diagnostics-max-wrap arg)
    (helix.inline-diagnostics-max-wrap *helix.config* arg))

(provide inline-diagnostics-max-diagnostics)
;;@doc
;;;;Inline diagnostics max diagnostics
(define (inline-diagnostics-max-diagnostics arg)
    (helix.inline-diagnostics-max-diagnostics *helix.config* arg))
