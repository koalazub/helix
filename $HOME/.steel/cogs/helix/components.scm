...
(define (theme-scope arg0) (helix.components.theme-scope *helix.cx* arg0))
...
;;```
;;event: Event?
(define key-event-escape? helix.components.key-event-escape?)
                    
(provide key-event-backspace?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-backspace? helix.components.key-event-backspace?)
                    
(provide key-event-enter?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-enter? helix.components.key-event-enter?)
                    
(provide key-event-left?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-left? helix.components.key-event-left?)
                    
(provide key-event-right?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-right? helix.components.key-event-right?)
                    
(provide key-event-up?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-up? helix.components.key-event-up?)
                    
(provide key-event-down?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-down? helix.components.key-event-down?)
                    
(provide key-event-home?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-home? helix.components.key-event-home?)
                    
(provide key-event-end?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-end? helix.components.key-event-end?)
                    
(provide key-event-page-up?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-page-up? helix.components.key-event-page-up?)
                    
(provide key-event-page-down?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-page-down? helix.components.key-event-page-down?)
                    
(provide key-event-tab?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-tab? helix.components.key-event-tab?)
                    
(provide key-event-delete?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-delete? helix.components.key-event-delete?)
                    
(provide key-event-insert?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-insert? helix.components.key-event-insert?)
                    
(provide key-event-null?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-null? helix.components.key-event-null?)
                    
(provide key-event-caps-lock?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-caps-lock? helix.components.key-event-caps-lock?)
                    
(provide key-event-scroll-lock?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-scroll-lock? helix.components.key-event-scroll-lock?)
                    
(provide key-event-num-lock?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-num-lock? helix.components.key-event-num-lock?)
                    
(provide key-event-print-screen?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-print-screen? helix.components.key-event-print-screen?)
                    
(provide key-event-pause?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-pause? helix.components.key-event-pause?)
                    
(provide key-event-menu?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-menu? helix.components.key-event-menu?)
                    
(provide key-event-keypad-begin?)
;;@doc
;;
...
;;```
;;event: Event?
(define key-event-keypad-begin? helix.components.key-event-keypad-begin?)
