...
(provide tree-sitter-layers)

;;@doc
;;Display language names of tree-sitter injection layers under the cursor.
(define (tree-sitter-layers . args)
    (helix.tree-sitter-layers *helix.cx* args))
...
(define (set-register . args)
    (helix.set-register *helix.cx* args))
